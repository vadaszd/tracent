...
from tracent_eye.svg_renderer import SVGRenderer, SimpleVerticalSymbols, mock_font
...
class TracentEyeTestCase(unittest.TestCase):
    ...
    def test_simple_diagram(self):
        ll1 = LifeLine(self.trace_diagram, dict(name='client', host='apollo'))
        ll2 = LifeLine(self.trace_diagram, dict(name='server'))
        v1 = Vertex(ll1, 0.0, {})
        v2 = Vertex(ll1, 0.2, {})
        v3 = Vertex(ll2, 0.21, {})
        ...
        # def f(x, y, lines):
        #     bb_xy, bb_wh, dy = mock_font.get_bounding_box(x, y, lines)
